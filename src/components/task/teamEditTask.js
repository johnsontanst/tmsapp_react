...
function TeamEditTask() {
    ...
    async function getPlans(){
        try{
            const planResult = await Axios.post('http://localhost:3000/all-plan/app', {app_Acronym:"123123"}, {withCredentials:true});
                ...
                <form onSubmit={onSubmit}>
                    ...
                    <div class="mb-6 grid lg:grid-cols-2 gap-4 grid-cols-1">
                        ...
                        <div>
                            ...
                            <select disabled onChange={(e)=>setTaskPlan(e.target.value)}  id="permitOpen" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option value=""></option>
